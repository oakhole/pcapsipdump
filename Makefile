...
pcapsipdump: pcapsipdump.cpp calltable.cpp calltable.h
	@$(CC) $(CPPFLAGS) $(LDFLAGS) $(DEFS) makefile-helpers/check_libpcap.c -o /dev/null $(LIBS) 2>/dev/null || (\
	  ...
	  false)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) $(DEFS) pcapsipdump.cpp calltable.cpp $(LDFLAGS) $(LIBS) -o pcapsipdump

pcapsipdump-debug: pcapsipdump.cpp calltable.cpp calltable.h
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) $(DEFS) -ggdb pcapsipdump.cpp calltable.cpp $(LDFLAGS) $(LIBS) -o pcapsipdump-debug
